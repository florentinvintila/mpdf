...
Please read before submitting issues and pull requests the [CONTRIBUTING.md](https://github.com/florentinvintila/mpdf/blob/development/.github/CONTRIBUTING.md) file.
